...
describe('<NotificationsItem />', () => {
    ...
    it('Verify that by passing dummy type and value props, it renders the correct html', () => {
        ...
        expect(wrapper.html()).to.equal(`<li class="defaultStyle_yq0dju-o_O-bold_hq5slr" data-notification-type="${props['data-notification-type']}">test</li>`);
    });
    ...
    it('Verify that by passing a dummy html prop, it renders the correct html', () => {
        ...
        const props = wrapper.props();
        expect(wrapper.html()).to.equal(`<li class="defaultStyle_yq0dju-o_O-bold_hq5slr" data-notification-type="${props['data-notification-type']}"><u>test</u></li>`);
    });
